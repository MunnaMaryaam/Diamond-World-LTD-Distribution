    ...
    <header className="bg-slate-900/95 backdrop-blur-md border-b border-slate-800 text-white sticky top-0 z-30 shadow-lg">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-2 sm:gap-4">
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-white border border-slate-700/80 flex items-center justify-center shadow-md shadow-black/40 shrink-0 group-hover:border-teal-400 transition-colors p-1">
              <DiamondWorldLogo className="w-full h-full text-slate-950" />
            </div>
            <div>
