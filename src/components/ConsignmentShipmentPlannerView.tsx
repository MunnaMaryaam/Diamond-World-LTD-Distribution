...
export const ConsignmentShipmentPlannerView: React.FC<ConsignmentShipmentPlannerViewProps> = ({
  ...
  const handleExportConsignmentExcel = () => {
    const exportData = recommendations.map((r, idx) => ({
      "SL": idx + 1,
      "Diamond Carat / Item": `${r.weight} ct`,
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div className="space-y-1.5">
            ...
            <p className="text-xs sm:text-sm text-slate-300 max-w-2xl leading-relaxed">
              Analyzes historical sales demand against depleted company stock. Bringing these specific diamond carats in the next shipment will directly restore lost sales and maximize revenue.
            </p>
          </div>
          ...
          <table className="w-full text-left border-collapse text-xs">
            <thead>
              <tr className="bg-slate-100 text-slate-600 font-semibold border-b border-slate-200">
                <th className="py-3 px-4">Carat / Item</th>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-bold text-slate-900 text-sm">{r.weight} ct Solitaire</span>
                </div>
