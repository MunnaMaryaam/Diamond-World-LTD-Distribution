                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="Search branch or carat..."
                ...
                <table className="w-full text-left border-collapse text-xs">
                  <thead>
                    <tr className="bg-slate-100 text-slate-600 font-semibold border-b border-slate-200">
                      ...
                      <th className="py-2.5 px-3">Carat Weight</th>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
              <div>
                <h3 className="text-sm font-bold text-slate-900">Diamond Carat Velocity & Sales Run-Rate</h3>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse text-xs">
                <thead>
                  <tr className="bg-slate-100 text-slate-600 font-semibold border-b border-slate-200">
                    <th className="py-2.5 px-4">Carat Weight</th>
                    <th className="py-2.5 px-3 text-center">Current Stock</th>
