...
export const AIAssistantDrawer: React.FC<AIAssistantDrawerProps> = ({
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: `Hello! I am **Movement Analysis AI**, your diamond solitaire earrings retail intelligence copilot.
...
• **Top Best-Seller:** ${report.top5BestSellingWeights[0]?.weight || '0.24'} ct Solitaire
• **Top Slow-Moving:** ${report.top5SlowMovingWeights[0]?.weight || '0.60'} ct Solitaire
...
How can I assist your inventory distribution strategy today?`
  ...
  const handleSendMessage = async (promptToSend?: string) => {
    ...
    try {
      ...
      const aiReply = data.analysis || data.error || 'I have audited your diamond solitaire distribution data.';
  ...
  const quickPrompts = [
    ...
    'Calculate capital locked in slow-moving carat weights',
