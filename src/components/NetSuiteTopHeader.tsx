...
import { AuthUser, SalesTimeframe } from '../types';
...
export const NetSuiteTopHeader: React.FC<NetSuiteTopHeaderProps> = ({
  ...
  const getBreadcrumbTitle = () => {
    ...
    if (activeView === 'option_allocation') return 'Stock Distribution > 0.02ct Solitaire Option Allocation';
    ...
    if (activeView === 'reports') {
      const names: Record<string, string> = {
        ...
        weights: 'Reports > Carat & Solitaire Velocity Analysis',
      ...
      <div className="bg-white border-b border-[#e2e8f0] px-3 sm:px-6 py-2.5 flex items-center justify-between gap-3 text-xs">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          >
            ...
            <div className="w-8 h-8 rounded-lg bg-[#17395c] text-white flex items-center justify-center p-1.5 shadow-sm group-hover:bg-[#0f2b48] transition-colors">
              <DiamondWorldLogo className="w-full h-full text-white" />
            </div>

            <div className="flex flex-col">
              <div className="flex items-center gap-1.5">
                <span className="font-black text-sm text-[#0f2b48] tracking-tight leading-none font-mono">
                  DIAMOND WORLD LTD
                </span>
                <span className="bg-[#17395c] text-white font-bold text-[9px] px-1.5 py-0.5 rounded tracking-wider uppercase font-mono">
                  STOCK ERP
                </span>
              </div>
              <span className="text-[10px] text-[#64748b] font-medium leading-tight mt-0.5">
        ...
        <form onSubmit={handleSearchSubmit} className="flex-1 max-w-xl mx-2 hidden sm:block">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search Showroom (e.g. GUL, DMD, UTT), Carat (0.02), Requisitions..."
            ...
            >
              ...
              <div className="hidden xl:flex flex-col text-left">
                ...
                <span className="text-[9px] text-[#64748b] leading-tight mt-0.5">
                  DWL • {currentUser?.role || 'Operations Admin'}
                </span>
              </div>
      ...
      <div className="bg-[#17395c] text-[#d6e2ec] px-2 sm:px-5 flex items-center justify-between text-[11px] font-semibold overflow-x-auto shadow-sm select-none">
        ...
        <div className="flex items-center gap-0.5 min-w-max">
          ...
          >
            ...
            <span>0.02ct Solitaire Allocation</span>
          </button>
          ...
          <div className="relative">
            ...
            {isReportsDropdownOpen && (
              ...
              >
                ...
                >
                  <span>Carat &amp; Weight Velocity Analysis</span>
                </button>
                <button
                  onClick={() => {
                    setIsReportsDropdownOpen(false);
      ...
      <div className="bg-[#f8fafc] border-b border-[#e2e8f0] px-3 sm:px-6 py-2 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
          ...
          <div className="flex items-center rounded bg-[#e2e8f0] p-0.5 text-[11px] font-bold">
            {(['1Y', '6M', '3M', '1M'] as SalesTimeframe[]).map((tf) => (
              <button
                key={tf}
