      ...
      >
        ...
        <div className="p-5 border-b border-[#0f3126] flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center p-1.5 shadow-md shadow-emerald-950/60 shrink-0">
              <DiamondWorldLogo className="w-full h-full text-[#071a14]" />
            </div>
            <div>
        ...
        <div className="flex-1 overflow-y-auto px-3.5 py-4 space-y-6 scrollbar-thin scrollbar-thumb-emerald-900 scrollbar-track-transparent">
          ...
          <div>
            ...
            <nav className="space-y-1">
              ...
              {/* Stock Allocation (0.02ct Matrix) */}
              <button
