...
export const NetSuiteHomeDashboard: React.FC<NetSuiteHomeDashboardProps> = ({
  ...
  // Derive realistic KPI stats based on report
  const totalStock = report.totalCurrentStock || 1700137;
  const totalSold = report.totalSold || 1701086;
  const solitaireStock = report.weightSummaries?.find(w => w.weight === '0.02')?.currentStock || 928250;
  const actionAlertsCount = report.actionAlerts?.length || 3;
  const dormantCount = report.agingBuckets?.find(b => b.bucket.includes('>2'))?.totalPieces || 10577;
  const consignmentCount = report.consignmentRecommendations?.length || 9;
  const activeBranchesCount = report.branchSummaries?.length || 18;
  const shortageBranchesCount = report.topShortageBranches?.length || 5;

  // Real diamond stock movement trend data (Pieces Sold vs Pieces in Stock)
  const stockMovementTrendData = [
    { period: "Jul '24", stock: 1620000, sold: 240000, target: 220000 },
    { period: "Aug '24", stock: 1640000, sold: 265000, target: 230000 },
    { period: "Sep '24", stock: 1590000, sold: 250000, target: 240000 },
    { period: "Oct '24", stock: 1680000, sold: 285000, target: 250000 },
    { period: "Nov '24", stock: 1650000, sold: 290000, target: 260000 },
    { period: "Dec '24", stock: 1720000, sold: 340000, target: 300000 },
    { period: "Jan '25", stock: 1750000, sold: 310000, target: 280000 },
    { period: "Feb '25", stock: 1690000, sold: 295000, target: 270000 },
    { period: "Mar '25", stock: 1730000, sold: 320000, target: 290000 },
    { period: "Apr '25", stock: 1710000, sold: 330000, target: 300000 },
    { period: "May '25", stock: totalStock, sold: 345000, target: 310000 },
  ];

  // Carat Weight Velocity Trend Data (Pcs sold across key weights)
  const caratVelocityTrendData = [
    { month: "Jul '24", value: 45000 },
    { month: "Aug '24", value: 48000 },
    { month: "Sep '24", value: 52000 },
    { month: "Oct '24", value: 51000 },
    { month: "Nov '24", value: 58000 },
    { month: "Dec '24", value: 72000 },
    { month: "Jan '25", value: 89000 },
  ];

  // Solitaire 0.02ct Monthly Demand Spike Data
  const solitaireDemandData = [
    { m: 'M1', val: 18000 },
    { m: 'M2', val: 21000 },
    { m: 'M3', val: 24000 },
    { m: 'M4', val: 29000 },
  ...
  return (
    <div className="w-full bg-[#f4f6f9] min-h-screen font-sans text-[#1e293b] p-3 sm:p-5 space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          <div className="bg-white rounded border border-[#d8dee6] shadow-2xs overflow-hidden">
            ...
            <div className="p-3 space-y-2 text-xs">
              ...
              {/* Reminder 2: Amber Bar -> 0.02ct Allocation */}
              <button
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-1.5">
                    ...
                    <span className="text-[11px] text-[#475569] font-medium leading-tight">
                      Showrooms Below Minimum 0.02ct Reserve
                    </span>
                  </div>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-1.5">
                    ...
                    <span className="text-[11px] text-[#475569] font-medium leading-tight">
                      Stagnant Diamond Stock Exceeding &gt;2 Years
                    </span>
                  </div>
                </div>
              </button>
            ...
            <div className="p-3 space-y-3 text-xs">
              ...
              <div>
                ...
                <div className="pl-4 pt-1 space-y-1 text-[#475569]">
                  ...
                  >
                    <span>•</span>
                    <span>0.02ct Solitaire Option Allocation</span>
                  </button>
                  <button
                    onClick={() => onNavigateView('reports', 'refill_demand')}
                    className="w-full text-left py-0.5 hover:text-[#0284c7] hover:underline cursor-pointer flex items-center gap-1"
              ...
              <div>
                ...
                <div className="pl-4 pt-1 space-y-1 text-[#475569]">
                  ...
                  >
                    <span>•</span>
                    <span>Carat Weight Velocity &amp; Demand</span>
                  </button>
                  <button
        ...
        <div className="lg:col-span-6 space-y-4">
          ...
          <div className="bg-white rounded border border-[#d8dee6] shadow-2xs overflow-hidden">
            ...
            <div className="p-3 grid grid-cols-2 sm:grid-cols-4 gap-2.5">
              ...
              {/* TILE 1: Mustard / Gold (#c59b27) -> 0.02ct Solitaire Allocation */}
              <button
                onClick={() => onNavigateView('option_allocation')}
                ...
                title="Open 0.02ct Solitaire Option Allocation"
              >
                <div className="mb-1.5 p-1 rounded bg-black/10 group-hover:scale-110 transition-transform">
                  <Gem className="w-5 h-5 text-white" />
                </div>
                <span className="font-bold text-xs leading-tight">0.02ct Allocation</span>
                <span className="text-[10px] text-amber-100 opacity-90 mt-0.5">Solitaire Balancing</span>
              </button>
              ...
              >
                ...
                <span className="text-[10px] text-slate-200 opacity-90 mt-0.5">Showrooms &amp; Carats</span>
              </button>
          ...
          {/* PORTLET 4: KEY PERFORMANCE INDICATORS (Real Diamond Stock KPIs) */}
          <div className="bg-white rounded border border-[#d8dee6] shadow-2xs overflow-hidden">
            <div className="px-3 py-2 border-b border-[#e2e8f0] flex items-center justify-between bg-[#ffffff]">
            ...
            <div className="p-3 space-y-3">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 border-b border-[#e2e8f0] pb-3">
                ...
                {/* Stat 3: 0.02ct Solitaires */}
                <div className="p-2 rounded bg-[#f8fafc] border border-[#e2e8f0]">
                  <div className="text-[10px] font-bold text-[#64748b]">0.02ct Solitaire</div>
                  <div className="flex items-center justify-between mt-0.5">
                    <div className="flex items-center text-amber-700 font-bold text-xs">
                      <ArrowUpRight className="w-3.5 h-3.5" />
                      <span>{solitaireStock.toLocaleString()}</span>
                    </div>
                ...
                <table className="w-full text-left text-[11px]">
                  ...
                  <tbody className="divide-y divide-[#f1f5f9] text-[#334155]">
                    ...
                    <tr className="hover:bg-[#f8fafc] transition-colors cursor-pointer" onClick={() => onNavigateView('reports', 'excel_sheet')}>
                      ...
                      <td className="py-1.5 px-2 text-right font-mono text-[#64748b]">1,498,879</td>
                      <td className="py-1.5 px-2 text-right font-bold text-emerald-700 font-mono">↑ 13.4%</td>
                    </tr>
                    ...
                    <tr className="hover:bg-[#f8fafc] transition-colors cursor-pointer" onClick={() => onNavigateView('reports', 'branches')}>
                      ...
                      <td className="py-1.5 px-2 text-right font-mono text-[#64748b]">1,640,150</td>
                      <td className="py-1.5 px-2 text-right font-bold text-emerald-700 font-mono">↑ 25.3%</td>
                    </tr>

                    <tr className="hover:bg-[#f8fafc] transition-colors cursor-pointer" onClick={() => onNavigateView('option_allocation')}>
                      <td className="py-1.5 px-2 font-semibold text-[#0f172a] pl-5">Solitaire 0.02ct Target Reserve</td>
                      <td className="py-1.5 px-2 text-[#64748b]">Option-wise Stock Allocated</td>
                      <td className="py-1.5 px-2 text-right font-mono font-bold text-amber-700">{solitaireStock.toLocaleString()} pcs</td>
                      <td className="py-1.5 px-2 text-right font-mono text-[#64748b]">854,765</td>
                      <td className="py-1.5 px-2 text-right font-bold text-emerald-700 font-mono">↑ 8.6%</td>
                    </tr>
                    ...
                    <tr className="hover:bg-[#f8fafc] transition-colors cursor-pointer" onClick={() => onNavigateView('movement_aging')}>
                      ...
                      <td className="py-1.5 px-2 text-right font-mono text-[#64748b]">9,215</td>
                      <td className="py-1.5 px-2 text-right font-bold text-rose-700 font-mono">↑ 14.8%</td>
                    </tr>
                    ...
                    <tr className="hover:bg-[#f8fafc] transition-colors cursor-pointer" onClick={() => onNavigateView('reports', 'refill_demand')}>
                      ...
                      <td className="py-1.5 px-2 text-right font-mono text-[#64748b]">2,998</td>
                    ...
                    <tr className="hover:bg-[#f8fafc] transition-colors cursor-pointer" onClick={() => onNavigateView('consignment_shipment')}>
                      ...
                      <td className="py-1.5 px-2 text-right font-mono text-[#64748b]">12</td>
        ...
        {/* ======================================================== */}
        {/* RIGHT COLUMN: Carat Velocity + Solitaire Demand + Branches */}
        {/* ======================================================== */}
        <div className="lg:col-span-3 space-y-4">
          
          {/* PORTLET 6: CARAT WEIGHT VELOCITY TREND */}
          <div className="bg-white rounded border border-[#d8dee6] shadow-2xs overflow-hidden">
            <div className="px-3 py-2 border-b border-[#e2e8f0] flex items-center justify-between bg-[#ffffff]">
              <span className="font-bold text-xs text-[#1e293b] tracking-tight">Carat Velocity Trend</span>
              <div className="w-4 h-0.5 bg-[#94a3b8] rounded-full" />
            </div>

            <div className="p-3">
              <div className="flex items-center justify-between mb-2">
                <span className="text-[10px] font-bold text-[#64748b]">Monthly Diamond Pieces Sold</span>
                <span className="text-[10px] text-emerald-700 font-bold">Peak: 89k pcs</span>
              </div>

              {/* Area Chart */}
              <div className="h-44 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={caratVelocityTrendData} margin={{ top: 5, right: 5, left: -25, bottom: 0 }}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#f1f5f9" />
                    ...
                    <Tooltip
                      ...
                      contentStyle={{ backgroundColor: '#ffffff', borderColor: '#cbd5e1', fontSize: '11px', borderRadius: '4px' }}
                    />
                    <Area type="monotone" dataKey="value" stroke="#0284c7" fill="#0284c7" fillOpacity={0.25} />
                  </AreaChart>
                </ResponsiveContainer>
              </div>

              <div className="mt-2 pt-2 border-t border-[#f1f5f9] flex items-center justify-between text-[10px] text-[#64748b]">
                <span>Top Velocity: <strong>0.02ct &amp; 0.03ct</strong></span>
                <span className="text-emerald-700 font-bold">↑ High Turnover</span>
              </div>
            </div>
          </div>

          {/* PORTLET 7: SOLITAIRE 0.02ct MONTHLY DEMAND */}
          <div className="bg-white rounded border border-[#d8dee6] shadow-2xs overflow-hidden">
            <div className="px-3 py-2 border-b border-[#e2e8f0] flex items-center justify-between bg-[#ffffff]">
              <span className="font-bold text-xs text-[#1e293b] tracking-tight">Solitaire 0.02ct Demand Run</span>
              <div className="w-4 h-0.5 bg-[#94a3b8] rounded-full" />
            </div>

            <div className="p-3">
              <div className="flex items-center justify-between mb-2">
                <span className="text-[10px] text-[#64748b]">Option Demand Run</span>
              ...
              <div className="h-36 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={solitaireDemandData} margin={{ top: 5, right: 5, left: -25, bottom: 0 }}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#f1f5f9" />
                    <XAxis dataKey="m" tick={{ fontSize: 9, fill: '#64748b' }} />
                    <YAxis tick={{ fontSize: 9, fill: '#64748b' }} tickFormatter={(v) => `${(v / 1000).toFixed(0)}k`} />
                    <Tooltip
                      formatter={(val: any) => [`${Number(val).toLocaleString()} pcs`, '0.02ct Demand']}
                      contentStyle={{ backgroundColor: '#ffffff', borderColor: '#cbd5e1', fontSize: '11px', borderRadius: '4px' }}
                    />
                    <Area type="monotone" dataKey="val" stroke="#d97706" fill="#d97706" fillOpacity={0.25} />
                  </AreaChart>
                </ResponsiveContainer>
              </div>

              <div className="mt-2 pt-1.5 border-t border-[#f1f5f9] flex items-center justify-between text-[10px] text-[#64748b]">
                <span>Option-Wise Target</span>
                <span className="font-mono font-bold text-amber-800">{solitaireStock.toLocaleString()} pcs</span>
              </div>
            </div>
          </div>
