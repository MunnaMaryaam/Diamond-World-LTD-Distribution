...
export const ERPLaunchpad: React.FC<ERPLaunchpadProps> = ({
  ...
  const erpModules = [
    ...
    },
    {
      ...
      category: 'inventory',
      title: 'Stock Allocation (Solitaire & Carats)',
      description: 'Algorithm-driven inter-branch stock allocation, 0.02 ct Solitaire distribution, transfer schedules, and surplus-to-deficit routing.',
      icon: Gem,
      iconColor: 'text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/60 border-amber-200 dark:border-amber-800',
      badge: '0.02ct & Carats Matrix',
    ...
    },
    {
      ...
      description: 'Procurement demand forecasting, supplier order suggestions, high-demand carats replenishment, and purchase requisition export.',
      icon: PackagePlus,
      ...
      stats: `${report.consignmentRecommendations?.length || 0} Recommended Procurement Carats`,
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-6 sm:p-8 shadow-xl shadow-slate-900/5 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-start sm:items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center p-1.5 shadow-md shrink-0">
              <DiamondWorldLogo className="w-full h-full text-slate-950 dark:text-white" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
            <div className="px-3 py-1.5 rounded-xl bg-slate-50 dark:bg-slate-800/90 border border-slate-200 dark:border-slate-700 text-xs flex items-center gap-2 text-slate-600 dark:text-slate-300">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <div className="relative flex-1 sm:w-64">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-1.5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs text-slate-800 dark:text-slate-200 placeholder-slate-400 focus:outline-hidden focus:ring-2 focus:ring-teal-500/30"
            />
            {searchQuery && (
              <button
            ...
            return (
              ...
              >
                <div className="flex items-start sm:items-center justify-between gap-4">
                        ...
                        <div className="pt-2 flex items-center gap-1.5 flex-wrap">
                          {module.subOptions.map((sub) => (
                            <button
                              ...
                              className="text-[11px] px-2.5 py-1 rounded-lg bg-slate-100 hover:bg-teal-50 dark:bg-slate-800 dark:hover:bg-teal-950/60 text-slate-700 dark:text-slate-300 hover:text-teal-700 dark:hover:text-teal-300 border border-slate-200 dark:border-slate-700 transition-all cursor-pointer font-medium"
                            >
                              {sub.label} →
                            </button>
                          ))}
                  ...
                  {/* Open Button */}
                  <div className="hidden sm:flex items-center gap-1 text-xs font-bold text-slate-700 dark:text-slate-200 group-hover:text-teal-600 dark:group-hover:text-teal-400 bg-slate-100 dark:bg-slate-800 group-hover:bg-teal-50 dark:group-hover:bg-teal-950/50 px-3.5 py-2 rounded-xl border border-slate-200 dark:border-slate-700 transition-all shrink-0">
